            ...
            angular.extend(this, {
                $onInit: function $onInit() {
                    ...
                    socket.on('playValue', function (socket) {
                        socket.tic[socket.ptidx][socket.idx].player == _this.currentUser.name ? socket.tic[socket.ptidx][socket.idx].value = 'x' : socket.tic[socket.ptidx][socket.idx].value = 'o';
